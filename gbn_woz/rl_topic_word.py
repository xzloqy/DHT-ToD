...
def main():
    ...
    saved_model = 'sys_config_log_model'
    exp_dir = os.path.join(saved_model, pretrained_folder, 'rl-2021-06-07-16-12-36')
    # create exp folder
    ...
    rl_config = Pack(
        ...
        rl_clip = 5.0,
        random_seed = 100,
        rl_best_model = os.path.join(exp_dir, 'reward_best.model'),
    ...
    reinforce.test()
    topic_list = reinforce.export_topic()
    print(topic_list)
