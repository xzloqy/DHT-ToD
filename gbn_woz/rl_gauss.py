...
from latent_dialog.models_task import GBNSGauss
import logging
...
def main():
    ...
    choose="gbn"
    if choose=="gbn":
        pretrained_folder = 'gbn_gauss128_w1000_True_T=[50, 30, 20]-2021-05-08-00-50-37'
        pretrained_model_id = 97
    else:
        pretrained_folder = 'base_gauss128-2021-05-08-00-49-31'
        pretrained_model_id = 70

    saved_model = 'gauss_model'
    exp_dir = os.path.join(saved_model, pretrained_folder, 'rl-'+start_time)
    # create exp folder
    ...
    # TARGET AGENT
    sys_model = GBNSGauss(corpus, sv_config)
