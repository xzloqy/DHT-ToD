...
def prepareSlotValuesIndependent(data_name='norm-multi-woz'):
    ...
    for domain in domains:
        try:
            fin = file(os.path.join(CUR_PATH.replace('latent_dialog/normalizer', ''), 'data/' + data_name + '/db/' + domain + '_db.json'))
    ...
    fin = open(os.path.join(CUR_PATH.replace('latent_dialog/normalizer', ''), 'data/' + data_name + '/db/train_db.json'))
